package projeto.teststore.utils;

public class TestData {
	
	
	public String urllogado = "https://automationteststore.com/index.php?rt=account/account";
	public String loginNameValido = "ian_joao_test";
